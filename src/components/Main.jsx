  ...
  return (
    <div className="w-full  h-[600px] text-white">
      <div className="w-full h-full ">
        ...
        <div className="absolute w-full top-[40%] md:top-[35%] lg:top-[30%] xl:top-[30%] p-4 md:p-8">
          ...
          <p className="w-full md:max-w-[70%] lg:max-w-[50%] xl:max-w[35%] text-gray-200 text-xs md:text-base lg:text-base xl:text-xl">
